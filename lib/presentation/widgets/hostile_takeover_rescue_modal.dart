...
class HostileTakeoverRescueModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Dialog(
      ...
      child: RetroWindow(
        title: '[MENAJER] ACİL KULÜP KURTARMA VE SERMAYE ARTIRIMI',
        child: Padding(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      Text('[ACIL]', style: TextStyle(fontSize: 26)),
                      SizedBox(width: 8),
                      Expanded(
                        child: Text(
                    ...
                    onPressed: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          ...
                          content: Text(
                            '[KASA] ŞAHSİ SERVETTEN ₣250.000 HİBE EDİLDİ! Kayyum tehlikesi savuşturuldu, güven tazelendi!',
