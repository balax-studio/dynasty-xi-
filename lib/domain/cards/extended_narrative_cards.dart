    ...
    return const [
      ...
      DecisionCard(
        ...
        options: [
          ...
          CardOption(
            id: 'nepotism_mentor',
            text: '[KILITLI] [Motivatör] Yeğeni akademiye gönderip özel rehberlik ata.',
      ...
      DecisionCard(
        ...
        options: [
          ...
          CardOption(
            ...
            text: '[KILITLI] [Tüccar] Komisyonu yasal sözleşmeye bağlayıp indirime zorla.',
      ...
      DecisionCard(
        ...
        options: [
          ...
          CardOption(
            ...
            text: '[KILITLI] [Sahne İnsanı] İğneleyici bir espriyle tüm kamuoyunu arkana al.',
      ...
      DecisionCard(
        ...
        options: [
          ...
          CardOption(
            ...
            text: '[KILITLI] [Taktikçi] Sezon sonuna kadar kalması için ikna edip şampiyonluk primi vaat et.',
