...
enum SeasonThemeType {
  youthFever('Gençlik Aşısı', 'Akademi oyuncularının antrenman gelişimine +%30 bonus.', 'STAR', 1.3, 1.0),
  goalFest('Gol Festivali', 'Tüm maçlarda xG ve hücum şansları +%20 artar.', '[FORM]', 1.0, 1.2),
  ironDefense('Çelik Savunma', 'Defansif bloklar daha sağlam; kalesinde gol görmeme primi 2 katına çıkar.', 'SHIELD', 1.0, 0.85),
  derbyHeat('Derbi Ateşi', 'Taraftar memnuniyeti ve bilet hasılatı +%25 yükselir.', 'BOLT', 1.0, 1.0);
