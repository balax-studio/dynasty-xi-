...
enum CoachingLicense {
  ...
  uefaB('UEFA B Lisansı (Ulusal Antrenör)', '3.', 5, 25000, 1.05),
  uefaA('UEFA A Lisansı (Kıtasal Taktisyen)', '2.', 10, 75000, 1.10),
  uefaPro('UEFA Pro Lisansı (Elit Menajer)', '1.', 20, 200000, 1.20);
