...
enum SkillBranchType {
  tactical('Taktik Dehası', 'BOLT'),
  motivational('Motivasyon Ustası', '[FORM]'),
  transfer('Transfer Kurdu', '[MENAJER]'),
  academy('Altyapı Mimarı', ''),
  financial('Finansal Büyücü', '[KASA]');
    ...
    return const ManagerSkillTree(
      branches: [
        SkillBranch(
          ...
          skills: [
            ManagerSkill(id: 'tac_1', name: 'Gegenpress Ustası', icon: 'BOLT', description: 'Rakip yarı sahada top kapma şansı +%12.'),
            ManagerSkill(id: 'tac_2', name: 'Duran Top Üstadı', icon: '[HEDEF]', description: 'Korner ve frikiklerden xG üretimi +%20.'),
            ManagerSkill(id: 'tac_3', name: 'Çelik Savunma', icon: 'SHIELD', description: 'Kalesini kapatma olasılığı +%15.'),
            ManagerSkill(id: 'tac_4', name: 'Hızlı Kontra', icon: '', description: 'Top kapıldıktan sonra şut şansı +%25.'),
            ManagerSkill(id: 'tac_5', name: 'Total Futbol', icon: 'STAR', description: 'Tüm saha oyuncularına +2 OVR geçici maç buffı.'),
          ],
        ),
        SkillBranch(
          ...
          skills: [
            ManagerSkill(id: 'mot_1', name: 'Devre Arası Ateşi', icon: '[FORM]', description: 'Devre arası konuşmalarında moral artışı 2 katı.'),
            ...
            ManagerSkill(id: 'mot_3', name: 'Kaptanlık Bağı', icon: 'CROWN', description: 'Kaptanın takıma sağladığı kimya bonusu +%25.'),
            ManagerSkill(id: 'mot_4', name: 'Geri Dönüş Ruhu', icon: 'BOLT', description: 'Mağlup durumdayken son 15 dakikada gol şansı +%30.'),
            ManagerSkill(id: 'mot_5', name: 'Sarsılmaz Birlik', icon: '[ANLASMA]', description: 'Takım kimyası asla 60 altına düşmez.'),
          ],
        ),
        SkillBranch(
          ...
          skills: [
            ManagerSkill(id: 'tra_1', name: 'Sert Pazarlıkçı', icon: '[MENAJER]', description: 'Bonservis pazarlıklarında başlangıç indirim payı +%15.'),
            ManagerSkill(id: 'tra_2', name: 'Menajer Ağı', icon: '[ANLASMA]', description: 'Menajer komisyonu ücretini %8 yerine %4 yapar.'),
            ManagerSkill(id: 'tra_3', name: 'Gözlem Radarı', icon: '', description: 'Scout keşif süresini %30 kısaltır.'),
            ManagerSkill(id: 'tra_4', name: 'Cevher Avcısı', icon: 'STAR', description: 'Gizli cevher (Wonderkid) keşif şansını 2 katına çıkarır.'),
            ManagerSkill(id: 'tra_5', name: 'Yıldız İkna Sanatı', icon: 'DIAMOND', description: 'Yüksek maaş talep eden yıldızlar maaşlarını %20 düşürür.'),
          ],
        ),
        SkillBranch(
        ...
        SkillBranch(
          ...
          skills: [
            ManagerSkill(id: 'fin_1', name: 'Sponsor Mıknatısı', icon: '[KASA]', description: 'Tüm sponsorluk gelirlerini +%20 artırır.'),
            ManagerSkill(id: 'fin_2', name: 'Kombine Patlaması', icon: '', description: 'Bilet ve stadyum hasılatına +%15 ek gelir.'),
            ManagerSkill(id: 'fin_3', name: 'Düşük Faiz', icon: '', description: 'Banka kredi faiz oranını %10 yerine %5 yapar.'),
            ManagerSkill(id: 'fin_4', name: 'Pasif Fonlar', icon: '[ARTIS]', description: 'Offline bekleme gelirlerini saatlik 2 katına çıkarır.'),
            ManagerSkill(id: 'fin_5', name: 'Kulüp Hanedanı', icon: 'CROWN', description: 'Her hafta kasaya sabit ₣5.000 kulüp fonu aktarılır.'),
          ],
        ),
      ],
    );
